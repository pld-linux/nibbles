...
Nibbles jest "odświeżoną" wersją klasycznej gry w Węża/Nibbles. Jestem
pewien, że istnieje lepsza taka gra, ale pomyślałem, że napiszę coś w
ncurses żeby się nauczyć jak to się robi.
